...
class ChatServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendExitMessage = channel.unary_unary(
                '/grpc.ChatServer/SendExitMessage',
                request_serializer=chat__pb2.ExitMessage.SerializeToString,
                response_deserializer=chat__pb2.Empty.FromString,
                )
...
class ChatServerServicer(object):
    ...
    def SendExitMessage(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ChatServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendExitMessage': grpc.unary_unary_rpc_method_handler(
                    servicer.SendExitMessage,
                    request_deserializer=chat__pb2.ExitMessage.FromString,
                    response_serializer=chat__pb2.Empty.SerializeToString,
            ),
    }
...
class ChatServer(object):
    ...
    def SendExitMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpc.ChatServer/SendExitMessage',
            chat__pb2.ExitMessage.SerializeToString,
            chat__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
